...
Except I don't: I use [add-lib](https://github.com/clojure/tools.deps.alpha/tree/add-lib3) branch of `tools.deps.alpha` that allows me to add dependencies dynamically at the REPL and then start using them, just like in the shell.
...
6 seconds vs 36 milliseconds! Function startup time and JIT FTW 🚀🚀🚀
...
What do you think? Discuss here or [on reddit](https://www.reddit.com/r/Clojure/comments/obm420/repl_vs_cli_ide_wars/).