...
| Edition | Lib                     | Version   |
|---------|-------------------------|-----------|
| Free    | `vlaaad/reveal`         | `1.3.275` |
| Pro     | `dev.vlaaad/reveal-pro` | `1.3.349` |
...
```clj
{:aliases {:reveal {:extra-deps {vlaaad/reveal {:mvn/version "1.3.275"}}
...
```clj
{:repl {:dependencies [[vlaaad/reveal "1.3.275"]]
        ;; optional: preferences
        :jvm-opts ["-Dvlaaad.reveal.prefs={:theme,:light}"]}}
```
