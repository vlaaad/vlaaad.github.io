...
| Edition | Lib                     | Version   |
|---------|-------------------------|-----------|
| Free    | `vlaaad/reveal`         | `1.3.309` |
| Pro     | `dev.vlaaad/reveal-pro` | `1.3.403` |
...
```clj
{:aliases {:reveal {:extra-deps {vlaaad/reveal {:mvn/version "1.3.309"}}
...
```clj
{:repl {:dependencies [[vlaaad/reveal "1.3.309"]]
        ;; optional: preferences
        :jvm-opts ["-Dvlaaad.reveal.prefs={:theme,:light}"]}}
```
