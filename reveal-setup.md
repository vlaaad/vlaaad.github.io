...
| Edition | Lib                     | Version   |
|---------|-------------------------|-----------|
| Free    | `vlaaad/reveal`         | `1.3.296` |
| Pro     | `dev.vlaaad/reveal-pro` | `1.3.388` |
...
```clj
{:aliases {:reveal {:extra-deps {vlaaad/reveal {:mvn/version "1.3.296"}}
...
```clj
{:repl {:dependencies [[vlaaad/reveal "1.3.296"]]
        ;; optional: preferences
        :jvm-opts ["-Dvlaaad.reveal.prefs={:theme,:light}"]}}
```
