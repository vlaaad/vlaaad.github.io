...
| Edition | Lib                     | Version   |
|---------|-------------------------|-----------|
| Free    | `vlaaad/reveal`         | `1.3.283` |
| Pro     | `dev.vlaaad/reveal-pro` | `1.3.365` |
...
```clj
{:aliases {:reveal {:extra-deps {vlaaad/reveal {:mvn/version "1.3.283"}}
...
```clj
{:repl {:dependencies [[vlaaad/reveal "1.3.283"]]
        ;; optional: preferences
        :jvm-opts ["-Dvlaaad.reveal.prefs={:theme,:light}"]}}
```
