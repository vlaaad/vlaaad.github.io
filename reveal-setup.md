...
| Edition | Lib                     | Version   |
|---------|-------------------------|-----------|
| Free    | `vlaaad/reveal`         | `1.3.327` |
| Pro     | `dev.vlaaad/reveal-pro` | `1.3.425` |
...
```clj
{:aliases {:reveal {:extra-deps {vlaaad/reveal {:mvn/version "1.3.327"}}
...
```clj
{:repl {:dependencies [[vlaaad/reveal "1.3.327"]]
        ;; optional: preferences
        :jvm-opts ["-Dvlaaad.reveal.prefs={:theme,:light}"]}}
```
